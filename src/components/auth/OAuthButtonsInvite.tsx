      ...
      <div className="space-y-3">
        {oauthProviders.map((provider, index) => (
          <motion.button
            ...
            className={`w-full flex items-center justify-center px-4 py-2 rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#7f00ff] ${provider.color}`}
