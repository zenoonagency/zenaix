import { ChatMessage as ChatMessageType } from "../../hooks/chat/use-chat-storage";
...
export const ChatMessage = ({ message }: ChatMessageProps) => {
  ...
  const { avatar_url } = useAuthStore((state) => state.user);
  ...
  return (
    ...
    >
      ...
      {isUser && (
        <div className="flex-shrink-0 w-8 h-8 rounded-full bg-purple-600 flex items-center justify-center overflow-hidden">
          {avatar_url ? (
            <img
              src={avatar_url}
