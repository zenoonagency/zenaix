...
export function BoardSelector({ boards = [], activeBoard, onSelectBoard, isOpen, onClose, onCreateBoard }: BoardSelectorProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[9999]">
      <div className={`w-full max-w-md p-6 rounded-lg shadow-xl m-4 ${isDark ? 'bg-dark-800' : 'bg-white'}`}>
            ...
            <div className={`text-center py-4 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
              ...
              {onCreateBoard && (
                <button
                  ...
                  className="flex items-center justify-center w-full mt-4 px-4 py-2 bg-[#7f00ff] text-white rounded-lg hover:bg-[#7f00ff]/90"
                >
