...
export function PerformanceTab() {
  ...
  const operationCountData = stats
    ? Object.entries(stats.operationCounts).map(([name, count]) => ({
        name,
        count,
      }))
    : [];
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div
          className={`${cardBg} ${borderColor} border rounded-lg p-4 shadow-sm`}
        >
              ...
              {slowOperations.length > 0 ? (
                slowOperations.map((op, idx) => (
                  ...
                  >
                    ...
                    <td
                      className={`px-6 py-4 whitespace-nowrap text-sm ${textColor} truncate max-w-xs`}
                    >
                ...
                <tr>
                  <td
                    colSpan={4}
                    className={`px-6 py-4 text-center text-sm ${textColor}`}
                  >
      ...
      {/* Dicas de otimização */}
      <div
        className={`${cardBg} ${borderColor} border rounded-lg p-4 shadow-sm mt-6`}
      >
        <h3 className={`text-lg font-medium mb-4 ${textColor}`}>
          Dicas de Otimização
        </h3>
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              >
                Uso excessivo das operações `getBoards` e `getBoardDetails` pode
                causar lentidão. Considere aumentar o tempo de cache ou
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              >
                Se você observar operações consistentemente lentas, considere
                simplificar consultas complexas ou adicionar índices no banco de
                dados.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              >
                Operações que falham frequentemente podem indicar problemas de
                permissão ou configuração no Supabase.
              </p>
            </div>
          </div>
        </div>
