    ...
    <div className="bg-white dark:bg-dark-700 rounded-lg shadow">
      <div className="p-6 border-b border-gray-200 dark:border-gray-700">
        <div className="flex justify-between items-center">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Transações Recentes</h2>
          <button
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        {filteredTransactions.map((transaction) => (
          ...
          >
            ...
            {transaction.associatedExpense !== undefined && transaction.associatedExpense > 0 && (
              <div className="mt-2 ml-12 text-sm text-gray-500 dark:text-gray-400">
                Despesa Associada: {formatCurrency(transaction.associatedExpense)}
              </div>
            )}
          </div>
        ))}
