...
export const ENDPOINTS = {
  ...
  CONVERSATIONS: {
    GET_QR_CODE: 'https://zenoon-agency-n8n.htm57w.easypanel.host/webhook-test/getqrcode',
    STATUS: 'https://zenoon-agency-n8n.htm57w.easypanel.host/webhook-test/status',
  },
  GOOGLE_CALENDAR: {
    USER_INFO: 'https://www.googleapis.com/oauth2/v3/userinfo',
  },
  PROFILE_MODAL: {
    CHECK_CONNECTING: 'https://fluxos-n8n.mgmxhs.easypanel.host/webhook/check_connecting',
    CHECK_EXISTING: 'https://fluxos-n8n.mgmxhs.easypanel.host/webhook/check-existing',
    QRCODE: 'https://fluxos-n8n.mgmxhs.easypanel.host/webhook/qrcode',
    CREATE_QR_CODE: 'https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://wa.me/',
  },
  HEADER: {
